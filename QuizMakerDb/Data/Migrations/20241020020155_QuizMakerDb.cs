        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowEmptyAnswers = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TeacherId = table.Column<int>(type: "int", nullable: false),
                    CourseYearSubjectId = table.Column<int>(type: "int", nullable: false),
                    Active = table.Column<bool>(type: "bit", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TeacherSubjects_CourseYearSubjects_CourseYearSubjectId",
                        column: x => x.CourseYearSubjectId,
                        principalTable: "CourseYearSubjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuizSubjects", x => x.Id);
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_QuizSubjects_Sections_SectionId",
                        column: x => x.SectionId,
                        principalTable: "Sections",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_QuizSubjects_Sections_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Sections",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuestionItems_QuizQuestions_QuizQuestionId",
                        column: x => x.QuizQuestionId,
                        principalTable: "QuizQuestions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AnswerStudents_QuestionAnswers_QuestionAnswerId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("9858076e-2e32-43ad-83f5-b4a692176296"), null, "Student", "STUDENT" },
                    { new Guid("d2d0e4de-17dc-49e4-b9ee-846784652a54"), null, "Teacher", "TEACHER" },
                    { new Guid("fb7dc09f-201e-45a9-b387-b8d4c0ea8407"), null, "Admin", "ADMIN" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("019ebbbd-aaf7-4cde-8087-c48616b430ce"), 0, true, "0e4a2453-b30c-40fb-ad02-630ac9407650", "student@domain.com", true, false, null, "STUDENT@DOMAIN.COM", "STUDENT", "AQAAAAIAAYagAAAAEOuwqXQssKaXxd56ggYUjMed+WR9djgnfnlZDbsAOl4mSMaX0E0tya5J7SG6SSjBaQ==", null, false, null, "c2885d85-c1bc-4bbb-a31a-2785592e82de", false, "Student" },
                    { new Guid("391affc7-508b-4bf4-b1e5-284aba2a0a34"), 0, true, "c8685a8b-fb2c-4f1f-a4a2-57b485c1ed54", "sysadmin@domain.com", true, false, null, "SYSADMIN@DOMAIN.COM", "SYSADMIN", "AQAAAAIAAYagAAAAEBeHgo6rrBVG/cE76ne8z5WM9w4Bozh3sszbQnveDZ4TxQ3G4eADYX2LNI/S6Kj89A==", null, false, null, "464e2548-3e71-4b0c-9e33-26419cddd279", false, "SysAdmin" },
                    { new Guid("5c9758d6-fb68-46f1-ba72-08ebb4017c26"), 0, true, "6f9e05b7-288e-4237-ad40-17c10aa4a403", "teacher@domain.com", true, false, null, "TEACHER@DOMAIN.COM", "TEACHER", "AQAAAAIAAYagAAAAEKcueDzLkx9oH0SzV7mysOVnjRBkxKtAALWmbtsOSMptoR8yTzdfHjfm31E35IHJFA==", null, false, null, "cdc23666-38ed-4b8b-b46b-5ceb5fe7bd0b", false, "Teacher" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("9858076e-2e32-43ad-83f5-b4a692176296"), new Guid("019ebbbd-aaf7-4cde-8087-c48616b430ce") },
                    { new Guid("fb7dc09f-201e-45a9-b387-b8d4c0ea8407"), new Guid("391affc7-508b-4bf4-b1e5-284aba2a0a34") },
                    { new Guid("d2d0e4de-17dc-49e4-b9ee-846784652a54"), new Guid("5c9758d6-fb68-46f1-ba72-08ebb4017c26") }
                });

            migrationBuilder.CreateIndex(
                name: "IX_AnswerStudents_QuestionAnswerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionItems_QuizQuestionId",
                table: "QuestionItems",
                column: "QuizQuestionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizSubjects_QuizId",
                table: "QuizSubjects",
                column: "QuizId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_QuizSubjects_SectionId",
                table: "QuizSubjects",
                column: "SectionId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeacherSubjects_CourseYearSubjectId",
                table: "TeacherSubjects",
                column: "CourseYearSubjectId");
